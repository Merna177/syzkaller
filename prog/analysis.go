...
func filterArguments(call *Call, requiredArg map[Arg]uint64, p *Prog) bool {
	...
	ForeachArg(call, func(arg Arg, ctx *ArgCtx) {
		...
		switch {
		case a.VmaSize != 0:
			ranges = append(ranges, dFetchAddr{a.Address / p.Target.PageSize, max(len, a.VmaSize/p.Target.PageSize)})
		case a.Res != nil:
			ranges = append(ranges, dFetchAddr{a.Address, max(len, a.Res.Size())})
		}
	})
...
func detectIntersection(ranges []dFetchAddr) bool {
